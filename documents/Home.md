...
Aura is a **spatial, agentic window manager** designed for the gen AI age. It rethinks the traditional desktop interface by replacing static windows with "Agentic Interface Respondents" (AIRs) that live in a shared, reactive environment called **The Space**.
