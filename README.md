...
-   **Data Analysis**: A [Query AUR](documents/Developer-Guide.md#standard-aursquery) can broadcast a selected dataset via [Flux](documents/Architecture.md#data-flow-flux).
-   **Complex Dashboards**: Build mission-control style interfaces where every panel is aware of the others context.

## Documentation Index

- [Architecture](documents/Architecture.md): Deep dive into the Registry, Flux Protocol, and Manifests.
